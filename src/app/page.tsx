...
import { PiggyBank, Users, Target, Zap, ShieldCheck, ChevronRight } from 'lucide-react';
      ...
      <main className="flex-1">
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-white">
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="border-none shadow-lg bg-background/50">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-primary text-primary-foreground">
          <div className="container px-4 md:px-6 mx-auto flex flex-col items-center text-center space-y-8">
            ...
            <Button asChild size="lg" variant="secondary" className="rounded-full px-12">
              <Link href="/onboarding">Empezar Onboarding</Link>
            </Button>
          </div>
        </section>
      </main>

      <footer className="w-full py-6 px-4 md:px-6 border-t flex flex-col sm:flex-row items-center justify-between gap-4">
